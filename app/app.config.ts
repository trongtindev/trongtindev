export default defineAppConfig({
  global: {
    ...
    meetingLink:
      'https://www.upwork.com/freelancers/~01898ae6ea67e1040e?mp_source=trongtindev',
    email: 'me@trongtin.dev',
    available: true,
  },
  ui: {
    colors: {
  ...
  footer: {
    ...
    links: [
      ...
      // },
      {
        ...
        to: 'https://github.com/trongtindev',
        target: '_blank',
        'aria-label': 'Tin Nguyen Trong on GitHub',
      },
    ],
  },
});
